    ...
    <h1 class="main-title" style="font-family: 'AncizarSans', sans-serif; font-size: 24px; font-weight: bold;">
        ...
        <div class="stats-container">
            <div class="row">
                ...
                <div class="col-md-2">
                    <div class="stat-card">
                        <div class="stat-number" id="career-credits">{{ $programStats['career_credits'] }}</div>
...
@push('scripts')
    ...
    <script src="{{ asset('js/simulation-init.js') }}?v={{ time() }}"></script>
    <script>
        initSimulationIndex({
            levelingSubjectsCodes: @json($levelingSubjects->pluck('code')->toArray())
        });
    </script>
